  ...
  return (
    <div>
      ...
      <div className=" bg-very-dark-blue">
        <div className="max-w-[1120px] md:mx-auto flex flex-col items-center md:gap-12 text-white  md:flex-row">
          <span className="py-10 md:py-5">
          ...
          <ul className="text-sm tracking-widest uppercase md:flex-row flex flex-col gap-[25px] text-center text-gray-300 ">
            <li>
          ...
          <div className="flex gap-[40px] py-12 md:py-6 md:items-center md:ml-auto">
            <a href="#facebook">
              <span>
